...
export default function AdminLayout({
  ...
  const navItems = [
    ...
    { name: "Orders", href: "/adminola/orders", icon: ShoppingCart, badge: "12" },
    ...
    { name: "Messages", href: "/adminola/messages", icon: Mail, badge: "3" },
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-xl border border-gray-100 py-3 z-40 animate-in fade-in zoom-in-95 duration-150">
                    ...
                    <div className="divide-y divide-gray-50 text-xs">
                      <div className="px-4 py-3 hover:bg-gray-50 transition-colors">
                        <p className="font-bold text-gray-900">New Order #1024</p>
                        <p className="text-gray-500 text-[11px] mt-0.5">John Doe placed an order for ₦15,000</p>
                        <span className="text-[10px] text-gray-400 mt-1 block">5 min ago</span>
                      </div>
                      <div className="px-4 py-3 hover:bg-gray-50 transition-colors">
                        <p className="font-bold text-gray-900">Low Stock Alert</p>
                        <p className="text-gray-500 text-[11px] mt-0.5">Wireless Earbuds inventory is below 5 units</p>
                        <span className="text-[10px] text-gray-400 mt-1 block">1 hour ago</span>
                      </div>
                      <div className="px-4 py-3 hover:bg-gray-50 transition-colors">
                        <p className="font-bold text-gray-900">New Customer Inquiry</p>
                        <p className="text-gray-500 text-[11px] mt-0.5">Sarah sent a message via Contact form</p>
