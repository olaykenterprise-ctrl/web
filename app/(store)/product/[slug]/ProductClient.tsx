  ...
  return (
    <div className="bg-white min-h-screen pb-32 md:pb-12">
        ...
        <div className="flex flex-col md:flex-row gap-12 mb-16">
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            ...
            <div className="hidden md:flex gap-4 mb-8">
              <button onClick={handleAddToCart} className="flex-1 bg-[#FFC107] hover:bg-[#F59E0B] text-black font-black text-lg py-4 rounded-2xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-yellow-500/20 hover:-translate-y-1">
                <ShoppingCart size={20} /> Add to Cart
              </button>
              <button onClick={handleBuyNow} className="flex-1 bg-black hover:bg-gray-900 text-white font-black text-lg py-4 rounded-2xl flex items-center justify-center gap-2 transition-all hover:-translate-y-1">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-50 flex items-center gap-3 shadow-2xl">
        ...
        <button onClick={handleAddToCart} className="flex-1 bg-[#FFC107] text-black font-black py-3 rounded-xl flex items-center justify-center gap-2">
           Add to Cart
        </button>
        <button onClick={handleBuyNow} className="flex-1 bg-black text-white font-black py-3 rounded-xl flex items-center justify-center gap-2">
